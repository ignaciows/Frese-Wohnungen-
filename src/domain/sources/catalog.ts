...
export const SEED_SOURCES: SeedSource[] = [
  ...
  {
    key: 'telegram-kanaele',
    name: 'Telegram-Kanäle (öffentlich)',
    websiteUrl: 'https://t.me/',
    category: 'SOCIAL_LOCAL',
    priority: 30,
    integrationMode: 'CUSTOM_SOURCE',
    discoveryAdapter: 'telegram',
    housingTypes: ['APARTMENT', 'WG_ROOM'],
    coverage: [{ kind: 'NATIONWIDE', value: '' }],
    filterMappings: socialLocalMapping,
    notes:
      'Viele möblierte Wohnungen, Zwischenmieten und Nachmieter-Gesuche laufen nur über Telegram und sind binnen Stunden weg. Gelesen wird die öffentliche Web-Ansicht (t.me/s/NAME) — ohne Konto, ohne Anmeldung, ohne API-Schlüssel. Private Gruppen sind so nicht erreichbar. Kanalnamen in den Einstellungen eintragen.',
    manualRecipe:
      'Kanäle finden: in Telegram nach „Wohnung <Stadt>", „WG <Stadt>", „Zwischenmiete <Stadt>" suchen und prüfen, ob der Kanal öffentlich ist (im Browser unter t.me/s/NAME sichtbar). Nur öffentliche Kanäle eintragen.',
  },
  {
    key: 'degewo',
    name: 'degewo (Berlin)',
    websiteUrl: 'https://www.degewo.de/immosuche',
    category: 'INSTITUTIONAL_LANDLORD',
    priority: 120,
    integrationMode: 'SEARCH_LINK',
    discoveryAdapter: 'linklist',
    ...
    filterMappings: municipalMapping,
    notes: 'Kommunale Wohnungsgesellschaft Berlin. Ergebnisliste ist automatisch lesbar (Stand 2026-08-10).',
  },
  {
    key: 'gewobag',
    name: 'Gewobag (Berlin)',
    websiteUrl: 'https://www.gewobag.de/fuer-mieter-und-mietinteressenten/mietangebote/',
    category: 'INSTITUTIONAL_LANDLORD',
    priority: 121,
    integrationMode: 'SEARCH_LINK',
    discoveryAdapter: 'linklist',
  ...
  {
    key: 'gdw-feed',
    name: 'GdW — Verband der Wohnungswirtschaft (Feed)',
    websiteUrl: 'https://www.gdw.de/',
    category: 'DIRECTORY',
    priority: 240,
    integrationMode: 'CUSTOM_SOURCE',
    discoveryAdapter: 'feed',
    housingTypes: ['APARTMENT'],
    coverage: [{ kind: 'NATIONWIDE', value: '' }],
    filterMappings: socialLocalMapping,
    notes:
      'Verbandsseite, keine Anzeigen — aber der Feed führt zu Mitgliedsunternehmen, über die sich lokale Genossenschaften finden lassen. Als Rechercheeinstieg gedacht, nicht als Anzeigenquelle.',
  },
];
